...
interface IStockToken {
    /// @dev   Function to mint the stock token into the user's wallet; called by an Admin wallet when the user
    ...
    /// @dev   Function to burn the stock token out of the user's wallet; called by an Admin wallet when the user
