...
contract StockToken is ERC20, Ownable, ReentrancyGuard, IStockToken {
    ...
    event Buy(address UserAddress, uint256 StockTokenAmount, uint256 StableCoinAmount, address StableCoinAddress);
    event Sell(address UserAddress, uint256 StockTokenAmount, uint256 StableCoinAmount, address StableCoinAddress);
